...
class Tv extends Product{
	Tv(){ super(100); } // 조상클래스의 생성자 Product(int price)을 호출한다.
						// super!! 잊지말자
...
class PolyArgumentTest3{ // 사실 이전의 Test2와 다른건 refund밖에 없다
	// refund에 적용되는 것과 각 함수들에 Vector함수의 사용을 넣었기 때문에 기능적으로는 같아도
	// Vector로 구현하는 형태로 약간씩 변현됐다.
